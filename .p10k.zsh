# Generated by Powerlevel10k configuration wizard on 2024-06-08 at 10:50 CEST.
...
function prompt_environment() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=29
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%23F'     # default foreground
